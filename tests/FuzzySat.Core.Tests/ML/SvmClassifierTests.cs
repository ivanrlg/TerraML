...
public class SvmClassifierTests
{
    ...
    public void Train_ClassifiesCorrectly()
    {
        ...
        var classifier = SvmClassifier.Train(samples, extractor, numberOfIterations: 50);
    ...
    public void Train_EmptySamples_Throws()
    {
        ...
        var act = () => SvmClassifier.Train(samples, extractor);
    ...
    public void Train_InvalidIterations_Throws()
    {
        ...
        var act = () => SvmClassifier.Train(samples, extractor, numberOfIterations: 0);
